...
const MusicShaderBlob = () => {
  ...
  useFrame((state) => {
    ...
    gsap.to(mesh.current.material.uniforms.pointscale, {
      value: pointscale,
      duration: 1,
    });
    gsap.to(mesh.current.material.uniforms.decay, {
      value: decay,
      duration: 1,
    });
    gsap.to(mesh.current.material.uniforms.size, {
      value: size,
      duration: 1,
    });
    gsap.to(mesh.current.material.uniforms.displace, {
      value: displace,
      duration: 1,
    });
    gsap.to(mesh.current.material.uniforms.complex, {
      value: complex,
      duration: 1,
    });
    gsap.to(mesh.current.material.uniforms.waves, {
      value: waves,
      duration: 1,
    });

    gsap.to(mesh.current.material.uniforms.eqcolor, {
      value: eqcolor,
      duration: 1,
    });
    gsap.to(mesh.current.material.uniforms.rcolor, {
      value: rcolor,
      duration: 1,
    });
    gsap.to(mesh.current.material.uniforms.gcolor, {
      value: gcolor,
      duration: 1,
    });
    gsap.to(mesh.current.material.uniforms.bcolor, {
      value: bcolor,
      duration: 1,
    });
  });
...
export default React.memo(MusicShaderBlob);
